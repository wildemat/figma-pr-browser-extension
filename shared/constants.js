...
export const SPEC_REGEX = {
  ...
  EXISTING_SPEC: /<!-- START_SPEC_(\d+) -->[\s\S]*?\*\*Design Link:\*\* \[View in Figma\]\(https:\/\/www\.figma\.com\/design\/([^/]+)\/\?node-id=([^&]+)&[^)]*version-id=([^&)]+)/g,
};
...
export const DEFAULT_CONFIG = {
  ...
  END_MARKER: '<!-- END_DESIGN_SPECS - WILL NOT DETECT FIGMA LINKS BELOW THIS LINE -->',
